...
bash "$ROOT_DIR/script/record_external_verification_evidence.sh" \
  ...
  --screenshot-set "${APP_STORE_SCREENSHOT_SET_SUMMARY:-Captured writing, AI chat, sync/API publish, SEO/social preview, deployment, maintenance, general drafts, Pro, privacy lock, and release readiness screens.}" \
