...
This disposable file was created by RepoPress release verification."
...
case "$PROVIDER" in
  github)
    ...
    if [[ "$MODE" == "review" ]]; then
      pr_body="{\"title\":\"Live verification: RepoPress\",\"head\":\"$REVIEW_BRANCH\",\"base\":\"$TARGET_BRANCH\",\"body\":\"Live PR verification generated by release evidence script.\"}"
...
print(json.dumps({
  ...
  "title": "Live verification: RepoPress",
