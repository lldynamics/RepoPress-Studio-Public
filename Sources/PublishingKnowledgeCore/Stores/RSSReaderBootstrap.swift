...
public struct RSSReaderBootstrap: Sendable {
  ...
  /// Creates the local RSS database and verifies its SQLite schema can be
  /// queried before a data root is considered ready.
  package static func createDatabaseAndValidate(
    at fileURL: URL,
