...
package struct KnowledgeEPUBBook: Sendable {
...
package struct KnowledgeEPUBParser: Sendable {
  package init() {}
  ...
  package func parse(data: Data, sourceName: String) throws -> KnowledgeEPUBBook {
