...
package struct KnowledgeWebSanitizedContent: Sendable {
  package var title: String?
  package var authors: [String]
  package var language: String?
  package var summary: String
  package var sections: [KnowledgeExtractedSection]
  package var removedNoiseBlockCount: Int
  package var selectedMainContent: Bool
}
...
package struct KnowledgeWebContentSanitizer: Sendable {
  package init() {}

  package func sanitize(data: Data, sourceName: String) throws -> KnowledgeWebSanitizedContent {
  ...
  package func sanitize(html: String) -> KnowledgeWebSanitizedContent {
  ...
  package func sanitizeExtractedText(_ text: String) -> [KnowledgeExtractedSection] {
    sections(from: normalizeExtractedText(text))
  }

  package func sanitizeExtractedReadingText(_ text: String) -> String {
  ...
  package func readableOriginalText(from data: Data) -> String? {
