...
public struct MarkdownSnippetExpansionContext: Hashable, Sendable {
...
public enum MarkdownSnippetLibraryService {
  ...
  public static func expandedMarkdown(
    ...
    return snippet.markdown
      .replacingOccurrences(of: "{{title}}", with: context.title.trimmedForPublishing.nilIfEmpty ?? "未命名文章")
      .replacingOccurrences(of: "{{slug}}", with: context.slug)
