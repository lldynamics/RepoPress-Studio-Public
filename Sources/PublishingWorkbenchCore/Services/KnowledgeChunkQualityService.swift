...
struct KnowledgeChunkQualityAssessment: Hashable, Sendable {
...
/// recommendations.
struct KnowledgeChunkQualityService: Sendable {
  func assessment(for content: String) -> KnowledgeChunkQualityAssessment {
