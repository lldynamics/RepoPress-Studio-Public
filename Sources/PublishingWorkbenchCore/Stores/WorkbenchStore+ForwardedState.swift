...
extension WorkbenchStore {
  ...
  public var repositoryOperationLifecycle: RepositoryOperationLifecycle? {
    repositoryMergeConflictSession?.operationLifecycle
  }

  public var repositoryRebaseRecoveryContext: RepositoryRebaseRecoveryContext? {
    repositoryStore.repositoryRebaseRecoveryContext(for: activeProfile)
  }

  public var repositoryRebaseRecoveryDiagnostic: String? {
    repositoryStore.repositoryRebaseRecoveryDiagnostic
  }
  ...
  public var remotePublishPreviewSnapshot: RemoteRepositoryPublishPreview? {
    publishingStore.remotePublishPreviewSnapshot
  }
  ...
  public var batchRemotePublishPreviewSnapshot: RemoteRepositoryPublishPreview? {
    publishingStore.batchRemotePublishPreviewSnapshot
  }
  ...
  public var localSitePreviewRuntimeStatus: LocalSitePreviewRuntimeStatus {
    publishingStore.localSitePreviewRuntimeStatus
  }
  ...
  public var automaticallyRefreshPreflightOnEdit: Bool {
    publishingStore.automaticallyRefreshPreflightOnEdit
  }
  ...
  public var maintenanceOperationRecords: [MaintenanceOperationRecord] {
    publishingStore.maintenanceOperationRecords
  }
  ...
  public var latestGeneralDraftReusePlan: GeneralDraftReusePlan? {
    publishingStore.latestGeneralDraftReusePlan
  }
}
...
extension WorkbenchStore {
  ...
  public var repositoryTokenAvailability: KeychainTokenAvailability {
    repositoryStore.repositoryTokenAvailability
  }
  public var remoteRepositoryAccessCheck: RemoteRepositoryAccessCheck? {
    repositoryStore.remoteRepositoryAccessCheck
  }
  public var remoteRepositoryCreationResult: RemoteRepositoryCreationResult? {
    repositoryStore.remoteRepositoryCreationResult
  }
  public var remoteRepositoryPublishResult: RemoteRepositoryPublishResult? {
    repositoryStore.remoteRepositoryPublishResult
  }
  public var remoteRepositoryPublishProgress: RemoteRepositoryPublishProgress? {
    repositoryStore.remoteRepositoryPublishProgress
  }
  public var remoteRepositoryRollbackResult: RemoteRepositoryRollbackResult? {
    repositoryStore.remoteRepositoryRollbackResult
  }
  public var remoteRepositoryReviewWithdrawalResult: RemoteRepositoryReviewWithdrawalResult? {
    repositoryStore.remoteRepositoryReviewWithdrawalResult
  }
  ...
  public var isRemoteConflictResolutionRunning: Bool {
    publishingStore.isRemoteConflictResolutionRunning
  }
  ...
  public var repositoryAutoSyncSettings: RepositoryAutoSyncSettings {
    repositoryStore.repositoryAutoSyncSettings
  }
  public var repositoryAutoSyncState: RepositoryAutoSyncState {
    repositoryStore.repositoryAutoSyncState
  }
...
extension WorkbenchStore {
  public var deploymentStatusSnapshots: [UUID: DeploymentStatusSnapshot] {
    deploymentStore.deploymentStatusSnapshots
  }
  public var deploymentStatusHistory: [UUID: [DeploymentStatusSnapshot]] {
    deploymentStore.deploymentStatusHistory
  }
  ...
  public var deploymentPollingSettings: DeploymentPollingSettings {
    deploymentStore.deploymentPollingSettings
  }
  public var deploymentPollingState: DeploymentPollingState {
    deploymentStore.deploymentPollingState
  }
  ...
  public var deploymentTokenAvailability: KeychainTokenAvailability {
    deploymentStore.deploymentTokenAvailability
  }
}
...
extension WorkbenchStore {
  ...
  public var aiMetadataApplicationRecords: [AIPublishingMetadataApplicationRecord] {
    aiWorkspaceStore.aiMetadataApplicationRecords
  }
  public var automationRunRecords: [WorkbenchAutomationRunRecord] {
    aiWorkspaceStore.automationRunRecords
  }
  ...
  public var aiMetadataSuggestion: AIPublishingMetadataSuggestion? {
    aiWorkspaceStore.aiMetadataSuggestion
  }
  ...
  public var aiChatKnowledgePolicy: KnowledgeRetrievalPolicy {
    aiWorkspaceStore.aiChatKnowledgePolicy
  }
  ...
  public var aiChatCustomPrompts: [AIPublishingCustomPrompt] {
    aiWorkspaceStore.aiChatCustomPrompts
  }
  ...
  public var seoSocialPreviewSnapshot: SEOSocialPreviewSnapshot? {
    aiWorkspaceStore.seoSocialPreviewSnapshot
  }
  ...
  public var isAIPublishingAssistantPresented: Bool {
    aiWorkspaceStore.isAIPublishingAssistantPresented
  }
}
