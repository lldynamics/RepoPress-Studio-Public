...
public struct RepositoryRebaseSyncService: Sendable {
  ...
  public func prepare(profile: any RepositorySyncProfile) throws -> RepositoryRebaseSyncPreparation
  {
  ...
  private func requiredRoot(_ profile: any RepositorySyncProfile) throws -> URL {
  ...
  private func validateContext(profile: any RepositorySyncProfile, root: URL) throws -> Context {
  ...
  private func validatedOrigin(_ raw: String, profile: any RepositorySyncProfile, root: URL) throws
    -> String
  {
