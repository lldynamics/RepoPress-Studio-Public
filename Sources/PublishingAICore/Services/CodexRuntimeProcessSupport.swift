...
package enum CodexRuntimeProcessEnvironment {
...
package struct CodexExecutableIdentity: Equatable {
  ...
  package static func capture(executableURL: URL) -> (url: URL, identity: Self)? {
...
package final class CodexRuntimeCStringArray {
  package let pointer: UnsafeMutablePointer<UnsafeMutablePointer<CChar>?>
