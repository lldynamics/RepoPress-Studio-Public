...
public struct LocalSitePreviewHTTPMetadataProbe: Sendable {
  public static func perform(_ request: URLRequest) async throws -> LocalSitePreviewPageProbeResult
  {
...
private final class LocalSitePreviewHTTPMetadataTransaction: @unchecked Sendable {
  ...
  private static func parseNextHeaderBlock(
    ...
    for line in lines.dropFirst() {
      ...
      responseHeaders[name] = String(line[line.index(after: separator)...])
        .trimmingCharacters(in: .whitespacesAndNewlines)
    }
