...
package enum CredentialedEndpointPolicy {
  package static func isSecureAPIBaseURL(_ url: URL) -> Bool {
  ...
  package static func isSecureRequestURL(_ url: URL) -> Bool {
    url.scheme?.lowercased() == "https"
      && url.host?.isEmpty == false
      && url.user == nil
      && url.password == nil
  ...
  package static func isAllowedAIRequestURL(_ url: URL, hasCredential: Bool) -> Bool {
  ...
  package static func isAllowedCredentialRedirect(from sourceURL: URL, to destinationURL: URL)
    -> Bool
  {
  ...
  package static func isAllowedSensitiveBodyRedirect(from sourceURL: URL, to destinationURL: URL)
    -> Bool
  {
