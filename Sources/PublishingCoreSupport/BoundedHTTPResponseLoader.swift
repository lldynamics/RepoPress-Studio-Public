...
package enum HTTPResponseLimitError: Error, Equatable, LocalizedError, Sendable {
  case invalidLimit
  ...
  package var maximumByteCount: Int {
    switch self {
    case .invalidLimit:
      return 0
    case let .responseTooLarge(maximumByteCount):
...
package enum BoundedHTTPResponseLoader {
  ...
  package static func validateExpectedLength(
