...
public struct WorkspaceBackupArticleSelectionPreview: Sendable {
  ...
  public init(
    ...
    articles: [WorkspaceBackupArticleSummary],
...
public struct WorkspaceBackupSelectiveRestorePreview: Sendable {
  ...
  public init(
    backupPreview: WorkspaceBackupPreview,
    availableCategories: [WorkspaceBackupCategory],
    selectedCategories: Set<WorkspaceBackupCategory>,
    replacementCategories: Set<WorkspaceBackupCategory>,
    categorySummaries: [WorkspaceBackupCategorySummary]
  ) {
    self.backupPreview = backupPreview
...
public struct WorkspaceBackupSelectiveRestoreStaging: Sendable {
  ...
  public init(preview: WorkspaceBackupSelectiveRestorePreview, stagedPackageURL: URL) {
