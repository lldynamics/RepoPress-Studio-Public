...
| `ai-chat` | `ai-chat.png` | AI workspace | Independent AI conversation, quick prompts, context article, regenerate, and apply actions. | Captured 1880x809 |
...
| `privacy-lock` | `privacy-lock.png` | Privacy lock | Locked workbench and private-content masking. | Captured 1880x809 |
| `release-readiness` | `release-readiness.png` | Release gate | Localization, UI runtime, screenshot, checklist, and product-readiness gates. | Captured 1880x809 |
