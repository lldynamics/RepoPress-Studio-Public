...
| `ai-chat` | `ai-chat.png` | BYOK AI writing assistant | Show the in-app AI assistant, safe demo conversation, model selection, and user-supplied API-key boundary. | Captured 2880x1800 |
